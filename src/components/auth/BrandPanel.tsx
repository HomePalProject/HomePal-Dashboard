  ...
  return (
    <div className="hidden md:flex w-[55%] bg-primary relative overflow-hidden flex-col justify-between p-12 px-40 md:px-12 text-text-inverse">
      ...
      <div className="z-10 max-w-xl mx-auto text-left flex flex-col items-start">
        <div className="inline-flex items-center gap-[8px] px-12 py-1.5 rounded-full bg-surface/10 border border-surface/20 text-13 font-medium text-surface/80 mb-24 motion-safe:animate-[slideUp_0.6s_ease-out_both]">
          <span className="w-[8px] h-[8px] rounded-full bg-accent shrink-0"></span>
          Household Management, Simplified
        </div>

        <h1 className="text-48 font-bold leading-tight mb-20 tracking-tight text-surface motion-safe:animate-[slideUp_0.6s_ease-out_80ms_both]">
          Manage every household, effortlessly.
        </h1>

        <p className="text-18 text-surface/70 leading-relaxed motion-safe:animate-[slideUp_0.6s_ease-out_160ms_both]">
