export function MockDashboardCard() {
  return (
    <div className="mt-10 bg-surface rounded-xl shadow-xl p-5 border border-border/10 w-full text-left">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-md bg-primary-container animate-pulse"></div>
          <div className="h-3.5 w-24 rounded bg-surface-variant animate-pulse"></div>
        </div>
        <div className="h-3 w-14 rounded bg-surface-variant animate-pulse"></div>
      </div>
      ...
      {[
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div className="h-3 w-28 rounded bg-surface-variant animate-pulse"></div>
          </div>
          <div className={`h-3 ${row.width} rounded bg-primary-container/60 animate-pulse`}></div>
        </div>
      ))}
      ...
      <div className="mt-4 pt-4 border-t border-border/20 flex gap-2">
        ...
        <div className="h-2.5 w-3/4 rounded-full bg-surface-variant animate-pulse"></div>
      </div>
    </div>
  );
}
