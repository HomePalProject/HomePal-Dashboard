...
export default function TableView({ categories, onEdit, onUpload }: TableProps) {
  return (
                  ...
                  <td className="px-16 py-3 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        onClick={() => onEdit(cat)}
                        title="Edit Category"
                        className="p-1.5 rounded-lg text-slate-600 hover:text-slate-900 hover:bg-slate-100 border-none bg-transparent"
                      >
                        <svg
                          width="14"
                          height="14"
